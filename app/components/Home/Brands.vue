    ...
    <section class="bg-[#1B2329] text-white min-h-screen bg-custom">
        ...
        <div class="max-w-7xl mx-auto px-6 lg:px-10">
            <div class="grid grid-cols-1 md:grid-cols-2 items-center gap-10 py-16 lg:py-24">
                ...
                <!-- Lado izquierdo: etiqueta, título y flechas -->
                <div class="order-2 md:order-1 my-10 flex flex-col gap-8">
                    <div class="flex items-center gap-3 mb-5">
                        <span class="h-px w-24 bg-[#F9BD6B]"></span>
                        <span class="ml-4 uppercase text-xs tracking-[0.25em] text-white">Algunos</span>
                    </div>
...
const logos = props.logos ?? [
    ...
    { src: '/marcaspicklog/cascanueces.png', alt: 'Cascanueces' },
    { src: '/marcaspicklog/boss.webp', alt: 'BOSS RECOVERY' },
    { src: '/marcaspicklog/campsfoods.webp', alt: 'Campsfoods' },
    { src: '/marcaspicklog/craftmoments.png', alt: 'Craft Moments' },
    { src: '/marcaspicklog/zulki.webp', alt: 'Zulki' },
]
