<template>
    <div class="w-full bg-transparent text-white flex flex-wrap justify-center items-start gap-6 sm:gap-8 pb-40">
        ...
        <div class="dropdown dropdown-hover relative">
            <div tabindex="0" role="button" class="w-[180px] sm:w-[220px] md:w-[260px] lg:w-[300px] h-[48px] md:h-[56px] lg:h-[64px] rounded-[36px] py-4 px-4 md:py-5 md:px-6 flex items-center justify-between 
