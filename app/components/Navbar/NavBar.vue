<template>
    <div :class="navbarClasses">
        <div class="flex items-center justify-end sm:justify-between h-full w-full relative">
            ...
            <div class="hidden lg:flex font-medium text-gray-300/70 z-10 absolute left-1/2 transform -translate-x-1/2">
            ...
            <div class="flex items-center justify-end lg:hidden z-10">
