<template>
    <section class="pt-20 sm:pt-10 bg-transparent text-white min-h-[600px] font-montserrat">
...
.estadistica-box {
    ...
    border: none;
    padding: 1rem 2.5rem; /* Aumentamos el padding para compensar la falta de borde */
}

.estadistica-box::before {
    content: '';
    position: absolute;
    top: 0;
    left: 0;
