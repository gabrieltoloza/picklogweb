<template>
    <div class="py-32 pt-40 pb-0 lg:py-24 lg:pt-32 min-h-screen">
...
useIntersectionObserver(el, (entries, observer) => {
    ...
    if (entry && entry.isIntersecting && !hasAppeared.value) {
        ...
        const timeLine1 = new CountUp('timeline-1', 2009, { duration: 2 , useGrouping: false });
        const timeLine2 = new CountUp('timeline-2', 2014, { duration: 2 , useGrouping: false });
        const timeLine3 = new CountUp('timeline-3', 2020, { duration: 2 , useGrouping: false });
        const timeLine4 = new CountUp('timeline-4', 2024, { duration: 2 , useGrouping: false });
