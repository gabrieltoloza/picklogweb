<template>
    <div class="w-full bg-transparent text-white flex flex-col justify-start items-center gap-20 pb-10 sm:pb-20 md:pb-32">
        ...
        <div class="sm:pr-96">
            <span class="text-left block text-xl font-semibold pr-60 sm:pr-[580px]">REQUISITOS:</span>
        </div>
        ...
        <div class="sm:mt-7 ml-25 sm:ml-50 self-start">
            <NuxtLink to="/transportistas-formulario"
                class="btn border-0 bg-[#F9BD6B] text-lg rounded-full p-3 px-9 w-60 h-16 sm:ml-[360px] font-normal text-white hover:bg-transparent hover:text-[#F9BD6B] transition-all duration-300">
                POSTULARME
            </NuxtLink>
        </div>
    </div>
